package com.medco.Travel.insurance.security.jwt;
...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        String roleUuid = userPrincipal.getRoleUuid();
        List<String> privileges = userPrincipal.getPrivileges();

        return Jwts.builder()
                .setSubject((userPrincipal.getUsername()))
                .claim("roleUuid", roleUuid)
